...
foreach ($name in 'Logging', 'State', 'Connections', 'Mapping', 'Preflight', 'Provisioning', 'MigrationSetup', 'MailboxMove', 'FileMove', 'Monitor', 'Reporting', 'Manifest', 'Groups', 'Permissions', 'ProjectReport') {
